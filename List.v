...
Fixpoint list_rec_ p
         ...
         (Hcons: forall (p0 : Obj) (α : p ≤ p0),
             ...
             (forall (p1 : Obj) (α0 : p0 ≤ p1),
                 listᶠ p1 (fun (p2 : Obj) (α1 : p1 ≤ p2) =>
                             A p2 (α ∘ (α0 ∘ α1)))) ->
             (forall (p : Obj) (α0 : p0 ≤ p), P p (α ∘ α0) p #) ->
             P p0 α p0 #)
         (l : listᶠ p A) {struct l} : P p # p # :=
            match l with
            | nilᶠ _ _ =>       Hnil p #
            | consᶠ _ _ ny ll => Hcons p # ny ll
                   (fun (p1 : Obj) (α1 : p ≤ p1) =>
                      list_rec_ p1 
  ...
  pose (Type_of_Hcons := fun p (A : Type_of_A p) (P : Type_of_P p A) =>
          ...
          (forall (p : Obj) (α0 : p0 ≤ p),
           list_memᶠ p
             ...
             p #) ->
          list_memᶠ p0 (fun (p : Obj) (α0 : p0 ≤ p) => A p (α ∘ α0))
...
(fix
 list_rec_ (p0 : Obj) (A0 P0 : forall p1 : Obj, p0 ≤ p1 -> forall p2 : Obj, p1 ≤ p2 -> Type)
           ...
           (l : listᶠ p0 (fun (r : Obj) (g : p0 ≤ r) => A0 r (fun (R : Obj) (k : Hom r R) => g R k))) {struct l} :
   P0 p0 # p0 # :=
   match l with
   | nilᶠ _ _ => Hnil0 p0 #
   | consᶠ _ _ ny ll =>
  ...
  (fun (p0 : Obj) (α : p ≤ p0)
   ...
   f p0 #
     (fun (p1 : Obj) (α0 : p0 ≤ p1) =>
      nilᶠ p1 (fun (r : Obj) (g : p1 ≤ r) => A r (fun (R : Obj) (k : Hom r R) => α R (α0 R (g R k))))))
  (fun (p0 : Obj) (α : p ≤ p0) (a : forall (p1 : Obj) (α0 : p0 ≤ p1), A p1 (α ∘ α0) p1 #)
     (_ : forall (p1 : Obj) (α0 : p0 ≤ p1),
          listᶠ p1 (fun (r : Obj) (g : p1 ≤ r) => A r (fun (R : Obj) (k : Hom r R) => α R (α0 R (g R k)))))
  ...
  exact ((fix F p (A : Type_of_A p) (P : Type_of_P p A)
              (Hnil : Type_of_Hnil p A P)
              (Hcons : Type_of_Hcons p A P)
              (l0 : listᶠ p A) : Goal_Type p A P Hnil Hcons l0   
         := 
